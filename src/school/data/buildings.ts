...
export const BUILDINGS: BuildingSpec[] = [
  ...
  },
  {
    ...
    valueBonus: 3,
    produces: { culture: 3, influence: 1 },
    defenseBonus: 0,
  },
  ...
  // 특수시설 — 특수 효과
  {
    ...
    category: 'special',
    name: '방송국',
    description: '학교 전체에 영향력을 뻗는다.',
    cost: cost({ influence: 3, culture: 1, actionPoints: 1 }),
    valueBonus: 3,
  ...
  },
  {
    ...
    category: 'special',
    name: '비밀기지',
    description: '아무도 모르는 거점.',
    cost: cost({ influence: 2, money: 2, actionPoints: 1 }),
    valueBonus: 2,
    produces: {},
    defenseBonus: 1,
  },
