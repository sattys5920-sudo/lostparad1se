// 말이 걷는다.
//
// 목적지를 찍으면 칸마다 15분씩 걸어간다. 앱을 꺼도 계속 걷는다.
// 도착 시각은 게임 시계로 센다 — 멈추는 구간을 다시 두게 되면
// 그때도 이 계산이 그대로 맞는다(clock.ts).
//
...
/**
 * 찍어 두는 목적지. 하루가 열릴 때(자정) 모든 팀의 예약이 동시에 출발한다.
 *
